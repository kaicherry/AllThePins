...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_kaicherry/c1bbbfd509830307020f87ba5aedc524/execroot/__main__',
    'ios_x86_64',
    {
        'tvos_x86_64': [
    ...
    set([
        '//AllThePins:AllThePinsApp',
    ]),
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/kaicherry/Library/Application Support/Tulsi/0.20190411.88/Bazel',
